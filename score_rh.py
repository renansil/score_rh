...
Original file is located at
    https://colab.research.google.com/drive/1f6qVvcw8PocPA-xs_f1AiduatL6KN83w

## Tarefa 2

O sistema de pontuação para priorização de candidatos foi desenvolvido com base nos seguintes requisitos identificados:


1.   Os candidatos devem ter preferência se estiverem localizados no mesmo estado de uma das sedes da empresa (Florianópolis, Recife ou São Paulo).
2.   Os candidatos ideais devem ter uma expectativa salarial dentro do orçamento mínimo e máximo para o cargo, mas não muito próximo desses valores.
3.  A adequação cultural à empresa é mais valorizada do que conhecimentos ou habilidades específicas.
4.  Para cargos que exigem conhecimento técnico, ter 5 anos de experiência com uma tecnologia específica qualifica o candidato como especialista nessa tecnologia.
5.  Os candidatos podem se candidatar a vários cargos relacionados, mas não a cargos não relacionados.


Este sistema de pontuação ajudará a filtrar e priorizar candidatos de forma eficaz.
...
candidato = candidatos_df.dropna(axis=0, how='any', inplace=False)
